...
function Navbar() {
  return (
    <div className="text-white w-full ">
      <div className="max-w-screen-lg mx-auto py-5 px-5 flex items-center border-b-[1px] border-b-zinc-600 justify-between">
                ...
                <a key={index} className="text-xs flex gap-2 items-center ">
                  {index === 1 && (
                    <span
                      ...
                      className="w-[7px] h-[7px] rounded-full inline-block bg-green-500"
                    ></span>
                  )}
                  {item}
                </a>
